...
int cmpfunc(const void *a, const void *b)
{
    int ia = *(const int *)a;
    int ib = *(const int *)b;
    return (ia > ib) - (ia < ib);  // retorna 1, 0 ou -1
}
...
int main(void)
{
    ...
    // ordenar o array antes de buscar
    qsort(arr, n, sizeof(int), cmpfunc);

    int res1 = binarysearch1(arr, 0, n - 1, x);
    int res2 = binarysearch2(arr, 0, n - 1, x);
    return 0;
}
